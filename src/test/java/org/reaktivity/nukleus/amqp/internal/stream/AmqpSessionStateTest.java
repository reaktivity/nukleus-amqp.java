...
import static org.reaktivity.nukleus.amqp.internal.stream.AmqpSessionState.BEGIN_RCVD;
import static org.reaktivity.nukleus.amqp.internal.stream.AmqpSessionState.BEGIN_SENT;
import static org.reaktivity.nukleus.amqp.internal.stream.AmqpSessionState.DISCARDING;
import static org.reaktivity.nukleus.amqp.internal.stream.AmqpSessionState.END_RCVD;
import static org.reaktivity.nukleus.amqp.internal.stream.AmqpSessionState.END_SENT;
import static org.reaktivity.nukleus.amqp.internal.stream.AmqpSessionState.ERROR;
